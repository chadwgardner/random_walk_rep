...
samples = np.random.normal(x_mean_dist, x_std_dist, size=10000)
x_ther, y_ther = ecdf(samples)
x_ecdf, y_ecdf = ecdf(x_distances)
...
plt.xlim(xmin=0)
plt.axvline(x=x_mean_dist, color='r', alpha=.4)
