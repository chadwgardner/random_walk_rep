...
#histogram
plt.subplot(2,1,1)
plt.hist(distances, normed=True, bins=30, alpha=0.4)
plt.hist(samples, histtype='stepfilled', normed=True, bins=30, alpha=0.4)
